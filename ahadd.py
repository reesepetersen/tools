...
#  Edited by Reese Petersen on 2018-Apr-11, fixed a non-functional typo
...
if __name__ == '__main__':
    ...
    parser.add_option("-n", "--n-files-at-once", action="store", type="int", dest="nAtOnce", default=20, help="combine this many files at one time [default 20]")
